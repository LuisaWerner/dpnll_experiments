...
class ArithmeticCircuit(object):
    ...
    def evaluate(
        ...
        values = None
        # evaluation of the neural predicates
    ...
    def extract_neural(self) -> List[Tuple[Term, Term]]:
        ...
        for w in weights:
            ...
            if type(w) is Term:
                if w.functor == "nn":
                    self._add_ordered_evaluation(w.args[0], w.args[1], neural_eval) # args[0] is the name of the neural predicate and 1 is the name of the term representing data
