...
class TrainObject(object):
    ...
    def get_loss(self, batch: List[Query], backpropagate_loss: Callable) -> float:
        ...
        for r in result:
            ...
            self.timing[3] += (r.ground_time + r.compile_time + r.eval_time) / len(batch)
        result = [
    ...
    def log(
        ...
        if verbose and self.i % log_iter == 0:
            ...
            self.logger.log("total_iter_time", self.i, self.timing[3] / log_iter)
